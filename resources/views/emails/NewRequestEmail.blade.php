...
@section('title',__('For Engineers'))
@section('content')

      <div class="container">
        <div class="" style="text-align: center; background-color: #212529; color: #fff; height: 3cm">
            <h1>{{ __('For Engineer Platform') }}</h1>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div style="background-color: #f8f9fa; padding: 20px; border-radius: 5px;">
                    <h2>{{ __('Your Request has been sent Kindly wait offers') }}</h2>
                <h3>{{ __('reference number') . ':'. $data['order_refrence'] }}</h3>
                ...
                <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
                  <tr>
                    <td style="font-size:0px;padding:10px 25px;padding-top:0px;padding-right:0px;padding-bottom:40px;padding-left:0px;word-break:break-word;">
                      <p style="border-top:solid 7px #3b3c13;font-size:1;margin:0px auto;width:100%;">
                      </p>
                      <!--[if mso | IE]>
        <table
           align="center" border="0" cellpadding="0" cellspacing="0" style="border-top:solid 7px #ECEEB2;font-size:1;margin:0px auto;width:600px;" role="presentation" width="600px"
        >
          <tr>
                        ...
                        <tbody>
                          <tr>
                            <td style="width:110px;">
                              <img alt="" height="auto" src="https://for-engineer.com/asset/img/logo2.png" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;" title="" width="110" />
                            </td>
                          </tr>
                        </tbody>
                      </table>
                        ...
                        <tbody>
                          <tr>
                            <td style="width:300px;">
                              <img alt="" height="auto" src="https://for-engineer.com/asset/img/success-message.png" style="border:none;display:block;outline:none;text-decoration:none;height:auto;width:100%;" title="" width="300" />
                            </td>
                          </tr>
                        </tbody>
                      </table>
                  ...
                  <tr>
                    <td align="left" style="font-size:0px;padding:0px 25px 0px 25px;padding-top:0px;padding-right:50px;padding-bottom:0px;padding-left:50px;word-break:break-word;">
                      <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                        <h1 style="text-align:center; color: #000000; line-height:32px">{{ __('Your Request has been sent Kindly wait offers') }}</h1>
                      </div>
                      <hr>
                      <div style="font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;line-height:22px;text-align:left;color:#797e82;">
                        <h3 style="text-align:center; color: #c20303; line-height:32px">{{ __('reference number') . ':' . $data['order_refrence']}}</h3>
                      </div>
                    </td>
                  </tr>
                  <tr>
                    <td align="center" vertical-align="middle" style="font-size:0px;padding:10px 25px;padding-top:20px;padding-bottom:20px;word-break:break-word;">
                      <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="border-collapse:separate;line-height:100%;">
                        <tr>
                          <td align="center" bgcolor="#ECEEB2" role="presentation" style="border:none;border-radius:100px;cursor:auto;padding:15px 25px 15px 25px;background:#ECEEB2;" valign="middle">
                            <a href="{{ env('APP_URL') }}" style="background:#ECEEB2;color:#222222;font-family:Open Sans, Helvetica, Arial, sans-serif;font-size:13px;font-weight:normal;line-height:120%;Margin:0;text-decoration:none;text-transform:none;" target="_blank">
                              <b style="font-weight:700"><b style="font-weight:700">{{ __('Go to website') }}</b></b>
                            </a>
                          </td>
                        </tr>
                      </table>
