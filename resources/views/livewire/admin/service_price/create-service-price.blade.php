            ...
            <form wire:submit.prevent="save">
                ...
                <div class="row text-center">
                    ...
                    <div class="col-lg-3">
                        ...
                        <input type="number" name="" id="" class="form-control @error('price') is-invalid @enderror" wire:model.defer="price"  min="0"/>
                        <span>@error('price') {{ $message }} @enderror</span>
                    </div>

                    <div class="col-lg-3">
                        <label for="">{{__('Site Present')}}</label>
                        <input type="number" name="" id="" class="form-control @error('present') is-invalid @enderror" wire:model.defer="present"  min="0"/>
